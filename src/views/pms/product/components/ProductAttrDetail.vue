<template>
  <div style="margin-top: 50px">
    <el-form
      ...
      size="small"
    >
      <el-form-item :label="$t('product.attr.propertyType')">
        <el-select
          v-model="value.productAttributeCategoryId"
          :placeholder="$t('product.attr.selectType')"
      ...
      <el-form-item :label="$t('product.attr.spec')">
        ...
        >
          ...
          <el-table-column
            :label="$t('product.attr.salesPrice')"
            width="100"
            align="center"
          >
            <template slot-scope="scope">
          ...
          <el-table-column
            :label="$t('product.attr.promotionPrice')"
            width="100"
            align="center"
          >
            <template slot-scope="scope">
        ...
        <el-button
          ...
          >{{ $t("product.attr.refreshList") }}
        </el-button>
        <el-button
          type="primary"
          style="margin-top: 20px"
          @click="handleSyncProductSkuPrice"
          >{{ $t("product.attr.syncPrice") }}
        </el-button>
        <el-button
          type="primary"
          style="margin-top: 20px"
          @click="handleSyncProductSkuStock"
          >{{ $t("product.attr.syncStock") }}
        </el-button>
      </el-form-item>
      <el-form-item :label="$t('product.attr.attrPic')" v-if="hasAttrPic">
        <el-card shadow="never" class="cardBg">
      ...
      <el-form-item :label="$t('product.attr.params')">
        <el-card shadow="never" class="cardBg">
          <div
      ...
      <el-form-item :label="$t('product.attr.album')">
        <multi-upload v-model="selectProductPics"></multi-upload>
      </el-form-item>
      <el-form-item :label="$t('product.attr.detail')">
        <el-tabs v-model="activeHtmlName" type="card">
          <el-tab-pane :label="$t('product.attr.pcDetail')" name="pc">
            <tinymce
              :width="595"
              :height="300"
          ...
          <el-tab-pane :label="$t('product.attr.mobileDetail')" name="mobile">
            <tinymce
              :width="595"
              :height="300"
  ...
  methods: {
    ...
    handleAddProductAttrValue(idx) {
      ...
      if (this.addProductAttrValue == null || this.addProductAttrValue == "") {
        this.$message({
          message: this.$t("product.attr.emptyValue"),
          type: "warning",
          duration: 1000
        });
        return;
      ...
      if (options.indexOf(this.addProductAttrValue) !== -1) {
        this.$message({
          message: this.$t("product.attr.duplicateValue"),
          type: "warning",
          duration: 1000
        });
        return;
    ...
    handleRefreshProductSkuList() {
      this.$confirm(
        this.$t("product.attr.refreshConfirm"),
    ...
    handleSyncProductSkuPrice() {
      this.$confirm(
        this.$t("product.attr.syncPriceConfirm"),
        this.$t("common.prompt"),
        {
          confirmButtonText: this.$t("common.confirm"),
          cancelButtonText: this.$t("common.cancel"),
    ...
    handleSyncProductSkuStock() {
      this.$confirm(
        this.$t("product.attr.syncStockConfirm"),
        this.$t("common.prompt"),
        {
          confirmButtonText: this.$t("common.confirm"),
          cancelButtonText: this.$t("common.cancel"),
