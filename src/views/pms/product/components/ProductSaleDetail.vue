<template>
  <div style="margin-top: 50px">
    <el-form
      ...
      size="small"
    >
      <el-form-item :label="$t('product.promotion.giftPoint')">
        <el-input v-model="value.giftPoint"></el-input>
      </el-form-item>
      <el-form-item :label="$t('product.promotion.giftGrowth')">
        <el-input v-model="value.giftGrowth"></el-input>
      </el-form-item>
      <el-form-item :label="$t('product.promotion.pointLimit')">
        <el-input v-model="value.usePointLimit"></el-input>
      </el-form-item>
      <el-form-item :label="$t('product.promotion.preview')">
        <el-switch
      ...
      <el-form-item :label="$t('product.promotion.publish')">
        <el-switch
      ...
      <el-form-item :label="$t('product.promotion.recommend')">
        <span style="margin-right: 10px">{{
          $t("product.promotion.new")
        }}</span>
        <el-switch
        ...
        <span style="margin-left: 10px;margin-right: 10px">{{
          $t("product.promotion.recommendLabel")
        }}</span>
        <el-switch
      ...
      <el-form-item :label="$t('product.promotion.service')">
        <el-checkbox-group v-model="selectServiceList">
          <el-checkbox :label="1">{{
            $t("product.promotion.noReturn")
          }}</el-checkbox>
          <el-checkbox :label="2">{{
            $t("product.promotion.fastRefund")
          }}</el-checkbox>
          <el-checkbox :label="3">{{
            $t("product.promotion.freeShipping")
          }}</el-checkbox>
        </el-checkbox-group>
      </el-form-item>
      <el-form-item :label="$t('product.promotion.detailTitle')">
        <el-input v-model="value.detailTitle"></el-input>
      </el-form-item>
      <el-form-item :label="$t('product.promotion.detailDesc')">
        <el-input v-model="value.detailDesc"></el-input>
      </el-form-item>
      <el-form-item :label="$t('product.promotion.keywords')">
        <el-input v-model="value.keywords"></el-input>
      </el-form-item>
      <el-form-item :label="$t('product.promotion.note')">
        <el-input
          v-model="value.note"
          type="textarea"
          :autoSize="true"
      ...
      <el-form-item :label="$t('product.promotion.promotionType')">
        <el-radio-group v-model="value.promotionType" size="small">
          <el-radio-button :label="0">{{
            $t("product.promotion.noDiscount")
          }}</el-radio-button>
          <el-radio-button :label="1">{{
            $t("product.promotion.special")
          }}</el-radio-button>
          <el-radio-button :label="2">{{
            $t("product.promotion.memberPrice")
          }}</el-radio-button>
          <el-radio-button :label="3">{{
            $t("product.promotion.ladder")
          }}</el-radio-button>
          <el-radio-button :label="4">{{
            $t("product.promotion.fullReduction")
          }}</el-radio-button>
        </el-radio-group>
      </el-form-item>
      <el-form-item v-show="value.promotionType === 1">
        <div>
          {{ $t("product.promotion.startTime") }}
          <el-date-picker
            v-model="value.promotionStartTime"
            type="datetime"
            :picker-options="pickerOptions1"
            :placeholder="$t('product.promotion.selectStart')"
          >
          </el-date-picker>
        </div>
        <div class="littleMargin">
          {{ $t("product.promotion.endTime") }}
          <el-date-picker
            v-model="value.promotionEndTime"
            type="datetime"
            :picker-options="pickerOptions1"
            :placeholder="$t('product.promotion.selectEnd')"
          >
          </el-date-picker>
        </div>
        <div class="littleMargin">
          {{ $t("product.promotion.promotionPrice") }}
          <el-input
            style="width: 220px"
            v-model="value.promotionPrice"
            :placeholder="$t('product.promotion.inputPrice')"
          ></el-input>
        </div>
      </el-form-item>
      ...
      <el-form-item v-show="value.promotionType === 3">
        <el-table :data="value.productLadderList" style="width: 80%" border>
          <el-table-column
            :label="$t('product.promotion.quantity')"
            align="center"
            width="120"
          >
          ...
          <el-table-column
            :label="$t('product.promotion.discount')"
            align="center"
            width="120"
          >
            <template slot-scope="scope">
      ...
      <el-form-item v-show="value.promotionType === 4">
        ...
        >
          <el-table-column
            :label="$t('product.promotion.full')"
            align="center"
            width="120"
          >
            <template slot-scope="scope">
          ...
          <el-table-column
            :label="$t('product.promotion.reduce')"
            align="center"
            width="120"
          >
            <template slot-scope="scope">
