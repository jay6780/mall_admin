<template>
  <div style="margin-top: 50px">
    <el-form
      ...
      size="small"
    >
      <el-form-item :label="$t('product.selectSubject') + '：'">
        <el-transfer
          style="display: inline-block"
          filterable
          :filter-method="filterMethod"
          :filter-placeholder="$t('common.pleaseEnter')"
      ...
      <el-form-item :label="$t('product.selectPreference') + '：'">
        <el-transfer
          style="display: inline-block"
          filterable
          :filter-method="filterMethod"
...
export default {
  ...
  data() {
    return {
      ...
      //专题左右标题
      subjectTitles: [
        this.$t ? this.$t("product.waiting") : "To be selected",
        this.$t ? this.$t("product.selected") : "Selected"
      ],
      //所有专题列表
      prefrenceAreaList: [],
      //专题左右标题
