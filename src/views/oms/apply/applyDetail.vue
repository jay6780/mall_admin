<template>
  <div class="detail-container">
    <el-card shadow="never">
      ...
      >
        <el-table-column
          :label="$t('oms.returnApply.productImage')"
          width="160"
          align="center"
        >
        ...
        <el-table-column
          :label="$t('oms.returnApply.productName')"
          align="center"
        >
          <template slot-scope="scope">
        ...
        <el-table-column
          :label="$t('oms.returnApply.priceSn')"
          width="180"
          align="center"
        >
          <template slot-scope="scope">
        ...
        <el-table-column
          :label="$t('oms.returnApply.quantity')"
          width="100"
          align="center"
        >
        ...
        <el-table-column
          :label="$t('oms.returnApply.subtotal')"
          width="100"
          align="center"
        >
    ...
    <el-card shadow="never" class="standard-margin">
        ...
        <el-row>
          ...
          <el-col class="form-border font-small" :span="18" style="height:50px">
            ...
            <el-button type="text" size="small" @click="handleViewOrder">{{
              $t("oms.returnApply.viewOrder")
            }}</el-button>
          </el-col>
        </el-row>
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">{{
            $t("oms.returnApply.applyTimeLabel")
          }}</el-col>
          <el-col class="form-border font-small" :span="18">{{
      ...
      <div class="form-container-border">
        ...
        <el-row>
          <el-col
            ...
            >{{ $t("oms.returnApply.refundAmount") }}
          </el-col>
        ...
        <div v-show="orderReturnApply.status !== 3">
          <el-row>
            <el-col
              ...
              :span="6"
              style="height:52px;line-height:32px"
              >{{ $t("oms.returnApply.choosePickup") }}
            </el-col>
            <el-col
              class="form-border font-small"
              style="height:52px"
          ...
          <el-row>
            <el-col class="form-border form-left-bg font-small" :span="6">{{
              $t("oms.returnApply.receiverName")
            }}</el-col>
            <el-col class="form-border font-small" :span="18">{{
              currentAddress.name
            }}</el-col>
          ...
          <el-row>
            <el-col class="form-border form-left-bg font-small" :span="6">{{
              $t("oms.returnApply.detailedAddress")
            }}</el-col>
            <el-col class="form-border font-small" :span="18">{{
      ...
      <div class="form-container-border" v-show="orderReturnApply.status !== 0">
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">{{
            $t("oms.returnApply.handleTimeLabel")
          }}</el-col>
          <el-col class="form-border font-small" :span="18">{{
      ...
      >
        <el-button type="primary" size="small" @click="handleUpdateStatus(1)">{{
          $t("oms.returnApply.confirmReturn")
        }}</el-button>
        <el-button type="danger" size="small" @click="handleUpdateStatus(3)">{{
          $t("oms.returnApply.rejectReturn")
        }}</el-button>
      </div>
      <div
        style="margin-top:15px;text-align: center"
      ...
      >
        <el-button type="primary" size="small" @click="handleUpdateStatus(2)">{{
          $t("oms.returnApply.confirmReceive")
        }}</el-button>
      </div>
    </el-card>
  </div>
...
export default {
  ...
  methods: {
    ...
    handleUpdateStatus(status) {
      ...
      this.$confirm(
        this.$t("oms.returnApply.confirmAction"),
        ...
        updateApplyStatus(this.id, this.updateStatusParam).then(response => {
          this.$message({
            type: "success",
            message: this.$t("oms.returnApply.actionSuccess"),
            duration: 1000
          });
          this.$router.back();
        });
